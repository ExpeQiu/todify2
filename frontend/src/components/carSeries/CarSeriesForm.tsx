...
const CarSeriesForm: React.FC<CarSeriesFormProps> = ({
  ...
  const [errors, setErrors] = useState<
    Partial<Record<keyof CarSeriesFormData, string>>
  >({});
  ...
  const validateForm = (): boolean => {
    ...
    if (
      ...
      formData.market_segment.trim().length > 100
    ) {
    ...
    if (formData.launch_year !== undefined) {
      ...
      if (
        ...
        formData.launch_year > currentYear + 5
      ) {
    ...
    >
      ...
      >
        ...
        <div
          ...
          data-oid=":mj:eq-"
        >
          <h2 className="text-xl font-bold text-gray-900" data-oid="_5peb0:">
            {carSeries ? "编辑车系" : "新增车系"}
          </h2>
          <button
            ...
            data-oid="9wb02cb"
          >
            <X className="w-5 h-5" data-oid="sggxw4_" />
          </button>
        </div>
        ...
        >
          ...
          {/* 基本信息 */}
          <div className="space-y-4" data-oid="u7w.x81">
            <h3
            ...
            <div data-oid="45pu9b.">
              ...
              >
                车系名称{" "}
                <span className="text-red-500" data-oid="oo36f_5">
                  *
                </span>
              </label>
              <input
              ...
              {errors.name && (
                <p className="mt-1 text-sm text-red-600" data-oid="ux2gntt">
                  {errors.name}
                </p>
              )}
            </div>
            ...
            <div data-oid="jpr:0cw">
              ...
              >
                所属品牌{" "}
                <span className="text-red-500" data-oid="k.bnea_">
                  *
                </span>
              </label>
              <select
                ...
                data-oid="ow_9t2l"
              >
                <option value={0} data-oid="ijr6fs2">
                  请选择品牌
                </option>
                {brands.map((brand) => (
                  <option key={brand.id} value={brand.id} data-oid="2v-2l-x">
                    {brand.name}
                  </option>
                ))}
              </select>
              {brandsLoading && (
                <p className="mt-1 text-sm text-gray-500" data-oid="sjovub:">
                  正在加载品牌列表...
                </p>
              )}
            </div>
            ...
            <div data-oid="r55loc3">
              ...
              >
                所属车型{" "}
                <span className="text-red-500" data-oid="ykh:w:r">
                  *
                </span>
              </label>
              <select
                ...
                onChange={(e) =>
                  handleInputChange("model_id", parseInt(e.target.value))
                }
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                  errors.model_id ? "border-red-300" : "border-gray-300"
                }`}
                disabled={
                  isSubmitting || carModelsLoading || selectedBrandId === 0
                }
                data-oid="mlys.dl"
              >
                <option value={0} data-oid="o:dcqm3">
              ...
              {errors.model_id && (
                <p className="mt-1 text-sm text-red-600" data-oid="ov1:y:f">
                  {errors.model_id}
                </p>
              )}
              {carModelsLoading && (
                <p className="mt-1 text-sm text-gray-500" data-oid="kwyjgsh">
                  正在加载车型列表...
                </p>
              )}
            </div>
            ...
            <div data-oid="v8-wu83">
              ...
              {errors.description && (
                <p className="mt-1 text-sm text-red-600" data-oid="5os-vt1">
                  {errors.description}
                </p>
              )}
            </div>
            ...
            <div data-oid="qhln8er">
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("market_segment", e.target.value)
                }
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
              ...
              {errors.market_segment && (
                <p className="mt-1 text-sm text-red-600" data-oid="ujbbv6r">
                  {errors.market_segment}
                </p>
              )}
            </div>
            ...
            >
              ...
              <div data-oid="e582t57">
                ...
                {errors.launch_year && (
                  <p className="mt-1 text-sm text-red-600" data-oid="e:.4ns8">
                    {errors.launch_year}
                  </p>
                )}
              </div>
              ...
              <div data-oid="2y9bfx_">
                ...
                {errors.end_year && (
                  <p className="mt-1 text-sm text-red-600" data-oid="jmln0vx">
                    {errors.end_year}
                  </p>
                )}
              </div>
            ...
            <div data-oid="73y4v__">
              ...
              <select
                ...
                onChange={(e) =>
                  handleInputChange("status", e.target.value as CarSeriesStatus)
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                disabled={isSubmitting}
                data-oid="ae35v1r"
              >
                <option value={CarSeriesStatus.ACTIVE} data-oid="v.pkibe">
                  在产
                </option>
                <option value={CarSeriesStatus.DISCONTINUED} data-oid="hgjnk92">
                  停产
                </option>
                <option value={CarSeriesStatus.PLANNED} data-oid="efjoitn">
                  计划中
                </option>
              </select>
            </div>
          ...
          >
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  <Save className="w-4 h-4" data-oid="3uw_kpi" />
                  {carSeries ? "更新车系" : "创建车系"}
                </>
              )}
            </button>
