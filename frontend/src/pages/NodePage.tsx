...
import LoadingAnimation, { LoadingButton } from '../components/LoadingAnimation';
...
const NodePage: React.FC = () => {
  ...
  const NodeComponent = node ? nodeComponents[node.type as keyof typeof nodeComponents] : null;
